...
ハンズオン（実践編）で構築する全体概要図は[こちらのリンク](https://github.com/uma-arai/cloudrun-handson-lite/blob/main/images/06-handson-architecture-overview-lite.png?raw=true)となります。
